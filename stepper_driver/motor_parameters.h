...
#define Z_DAE_ACCEL_MAX			50.0F	// maximal acceleration on this axis, [rad/sec^2]
#define Z_DAE_DECEL_MAX			50.0F	// maximal deceleration on this axis, [rad/sec^2]
#define Z_DAE_SPEED_MAX			500.0F	// maximal speed on this axis [rad/sec]
